        ...
        public void Populate(Mesh m)
        {
            ...
            if (normalAccessor != null)
            {
                ...
                for (int i = 0; i < normals.Length; i++)
                {
                    ...
                    //Debug.Log("Export normal: " + normals[i]);
                }
                normalAccessor.Populate(normals,false);
            }
            ...
            if (jointAccessor != null && m.boneWeights != null)
            {
                Vector4[] bones = boneWeightToBoneVec4(m.boneWeights);
                jointAccessor.PopulateShort(bones);
            }
            if (weightAccessor != null && m.boneWeights != null)
            {
